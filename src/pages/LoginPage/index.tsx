    ...
    <div className="flex items-center justify-center min-h-screen w-full overflow-hidden p-4">
      ...
      >
        <div className="flex flex-col gap-6">
          {/* Form Login - Passing Props Captcha */}
          <FormLogin 
          ...
          <div className="flex flex-col gap-2">
            <label className="text-[10px] font-black uppercase text-zinc-500">Verifikasi Keamanan</label>
            ...
            <input
              ...
              className="w-full border-2 border-zinc-950 p-2 font-mono text-sm uppercase focus:ring-0 focus:outline-none"
              value={captchaInput}
